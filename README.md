...
# Note that Redis will write a pid file in /data/data/com.termux/files/usr/var/run/redis.pid when daemonized.
...
# is used even if not specified, defaulting to "/data/data/com.termux/files/usr/var/run/redis.pid".
#
